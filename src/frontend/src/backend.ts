...
export class Backend implements backendInterface {
    ...
    async deleteLeadById(arg0: LeadId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteLeadById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterLeadsByCountry(arg0: string): Promise<Array<[LeadId, LeadInquiry]>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterLeadsByCountry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterLeadsByProductInterest(arg0: string): Promise<Array<[LeadId, LeadInquiry]>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterLeadsByProductInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllLeads(): Promise<Array<[LeadId, LeadInquiry]>> {
        if (this.processError) {
            try {
    ...
    async getLeadById(arg0: LeadId): Promise<LeadInquiry> {
        if (this.processError) {
            try {
    ...
    async searchLeads(arg0: string): Promise<Array<[LeadId, LeadInquiry]>> {
        if (this.processError) {
            try {
    ...
    async submitInquiry(arg0: LeadInquiry): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async totalLeadsCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.totalLeadsCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
